...
fn test_byte_code_macro() {
    ...
    let code = byte_code! {
        ...
        reas 79, 80;
        lcst [81], 82;
        lglb {"eighty three".to_string()}, 84;
        sglb 85, {"eighty six".to_string()};
        luv ^87, 88;
        suv 89, ^90;
        noop;
    };
    ...
    assert_equal(
        ...
        vec![
            ...
            OpCode::BinaryOperation {
                operation: BinaryOperation::FloorDivide,
                left: 22,
                right: 23,
                destination: 24,
            },
            ...
            OpCode::LoadGlobal {
                global: "eighty three".to_string(),
                register: 84,
            },
            OpCode::SaveGlobal {
                register: 85,
                global: "eighty six".to_string(),
            },
            OpCode::LoadUpValue {
                up_value: 87,
                register: 88,
